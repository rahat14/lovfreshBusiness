...
public class SlotSelectionActivity_ViewBinding implements Unbinder {
  private SlotSelectionActivity target;

  @UiThread
  public SlotSelectionActivity_ViewBinding(SlotSelectionActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SlotSelectionActivity_ViewBinding(SlotSelectionActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SlotSelectionActivity target = this.target;
