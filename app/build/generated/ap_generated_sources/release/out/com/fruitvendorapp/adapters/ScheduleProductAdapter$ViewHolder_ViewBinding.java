...
public class ScheduleProductAdapter$ViewHolder_ViewBinding implements Unbinder {
  private ScheduleProductAdapter.ViewHolder target;

  @UiThread
  public ScheduleProductAdapter$ViewHolder_ViewBinding(ScheduleProductAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ScheduleProductAdapter.ViewHolder target = this.target;
