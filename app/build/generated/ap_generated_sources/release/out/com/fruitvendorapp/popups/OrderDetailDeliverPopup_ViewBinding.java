...
public class OrderDetailDeliverPopup_ViewBinding implements Unbinder {
  private OrderDetailDeliverPopup target;

  @UiThread
  public OrderDetailDeliverPopup_ViewBinding(OrderDetailDeliverPopup target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public OrderDetailDeliverPopup_ViewBinding(OrderDetailDeliverPopup target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    OrderDetailDeliverPopup target = this.target;
