...
public class ShopOnlineProductAdapter$ViewHolder_ViewBinding implements Unbinder {
  private ShopOnlineProductAdapter.ViewHolder target;

  @UiThread
  public ShopOnlineProductAdapter$ViewHolder_ViewBinding(ShopOnlineProductAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ShopOnlineProductAdapter.ViewHolder target = this.target;
