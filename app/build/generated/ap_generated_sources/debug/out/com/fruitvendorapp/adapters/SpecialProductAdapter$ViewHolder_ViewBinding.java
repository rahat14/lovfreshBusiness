...
public class SpecialProductAdapter$ViewHolder_ViewBinding implements Unbinder {
  private SpecialProductAdapter.ViewHolder target;

  @UiThread
  public SpecialProductAdapter$ViewHolder_ViewBinding(SpecialProductAdapter.ViewHolder target,
      View source) {
    this.target = target;
    ...
    target.llMainView = Utils.findRequiredViewAsType(source, R.id.ll_main_view, "field 'llMainView'", LinearLayout.class);
  ...
  @CallSuper
  public void unbind() {
    SpecialProductAdapter.ViewHolder target = this.target;
