...
public class UploadProductActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public UploadProductActivity_ViewBinding(UploadProductActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UploadProductActivity_ViewBinding(UploadProductActivity target, View source) {
    this.target = target;
    ...
    target.edQuanity = Utils.findRequiredViewAsType(source, R.id.ed_quantity, "field 'edQuanity'", AppCompatEditText.class);
  ...
  @CallSuper
  public void unbind() {
    UploadProductActivity target = this.target;
